...
public class PatternFinderUtils {
	...
	/**
	 * Check for components and leave only one, done IN-PLACE. If random is not null, select a random component as the only one. Otherwise select the
	 * largest component.
	 * 
	 * @param random
	 * @param genes
...
//		System.lineSeparator();
	 ...
	 * @return
	 */
	public static void calculateRelationHistogram(PatternChromosome patternChromosome) {
		...
		if (numRelations == 0 || numRelations == 1) {
